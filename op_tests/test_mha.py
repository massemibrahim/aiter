...
def run_ck(
    ...
    print("Enter run_ck from op_tests/test_mha.py")

    print("Call aiter.flash_attn_func")
...
def test_flash_attn_output(
    ...
    print("Enter test_flash_attn_output from op_tests/test_mha.py")
    ...
    print("End of test_flash_attn_output")

if __name__ == '__main__':
    print("Enter main from op_tests/test_mha.py")
    ...
    print("Call test_flash_attn_output")
